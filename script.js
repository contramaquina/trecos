...
function exibirPremiosIndividuais() {
  var nivelDesafio = parseInt(document.getElementById("nivelDesafio").value);
  var d100 = getRandomInt(1, 100);
  var pc = '', pp = '', pe = '', po = '', pl = '';

  if (nivelDesafio < 1 || nivelDesafio > 20) {
    alert("Erro: Insira um valor de nível válido (1 a 20).");
    return;
  }

  if (nivelDesafio >= 1 && nivelDesafio <= 4) {
    // similar logic for this level
    // ...
  } else if (nivelDesafio >= 5 && nivelDesafio <= 10) {
    // similar logic for this level
    // ...
  } else if (nivelDesafio >= 11 && nivelDesafio <= 16) {
    // similar logic for this level
    // ...
  } else if (nivelDesafio >= 17 && nivelDesafio <= 20) {
    // similar logic for this level
    // ...
  }

  var resultado = "Resultado do dado: " + d100 + "\\n" +
